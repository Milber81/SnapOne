...
-keepclassmembers class com.snapone.domain.models.* {
    public <init>();
}
...
-keep class com.snapone.weatherproject.domain.models.** { *; }

-keep class com.snapone.weatherproject.domain.models.common.** { *; }
